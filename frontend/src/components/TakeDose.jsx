...
export const TakeDose = () => {
    ...
    const addUser = async (e) => {
        ...
        const Data = {
            ...
            'centre': "622b25e7ce5c4fc8fd87b5e8",
            'email': email,
            'id_region':idRegion
        };
        console.log(Data);
        // await axios.post('http://localhost:4000/api/personne', Data)
    ...
    const getRegion = async () => {
        const RegionRes = await axios.get('http://localhost:4000/api/region')
    ...
    const getCentre = async () => {
        ...
        // console.log(region)
        const centerRes = await axios.get(`http://localhost:4000/api/centre/${idRegion}`)
                    ...
                    <div className="  md:my-16 lg:py-16 py-10 w-full md:mx-24 md:px-12 px-4 flex flex-col items-center justify-center relative z-40">
                        ...
                        <div className="m-4 flex">
                            <input className="rounded-l-lg p-4 border-t mr-0 border-b border-l text-gray-800 border-gray-200 bg-white"
                                ...
                                required
                            />
                            <button className="px-8 rounded-r-lg bg-blue-400  text-gray-800 font-bold p-4 uppercase border-blue-500 border-t border-b border-r" onClick={() => serch()}>Serche</button>
                        </div>
                    </div>
                </div>
            }
                            ...
                            <form onSubmit={addUser} className="bg-white p-10 rounded-lg shadow-lg min-w-full">
                                ...
                                <div>
                                    ...
                                    <select className="w-full bg-gray-100 px-4 py-2 rounded-lg focus:outline-none"
                                        onChange={(e) => { setCenterByregion(e.target.value) }}

                                    >
                                        {regionData.map(region => (

                                            <option key={region._id}
                                ...
                                {/* dose */}
                                <div className="main flex border rounded-full overflow-hidden m-4 select-none bg-white">
                                    <div className="title py-3 my-auto px-8 bg-red-500 text-white text-sm font-semibold ">DOSE</div>
                                    <label className="flex radio p-2 cursor-pointer ">
                                        <input className="my-auto transform scale-125" type="radio"
                                            name="dose" value="firstDose"
                                            onChange={(e) => setDose(e.target.value)}
                                            onClick={(e) => showFirstDose(e)} />
                                        <div className="title px-2">1ere dose</div>
                                    </label>
                                    ...
                                    <label className="flex radio p-2 cursor-pointer">
                                        <input className="my-auto transform scale-125" type="radio"
                                            ...
                                            onChange={(e) => setDose(e.target.value)} />
                                        <div className="title px-2">2eme dose</div>
                                    </label>
                                    <label className="flex radio p-2 cursor-pointer">
                                        <input className="my-auto transform scale-125" type="radio"
                                            ...
                                            onChange={(e) => setDose(e.target.value)} />
                                        <div className="title px-2">3eme dose</div>
                                    </label>
                                </div>
                                {/* findose */}
                                ...
                                {firstHid &&
                                    <div className="main flex border rounded-full overflow-hidden m-4 select-none bg-white">
                                        <div className="title py-3 my-auto px-8 bg-red-500 text-white text-sm font-semibold ">Vous souffrez d'une maladie ?</div>
                                        <label className="flex radio p-2 cursor-pointer ">
                                            <input className="my-auto transform scale-125" type="radio"
                                                onClick={(e) => showInput(e)}
                                                value="oui" name="maladie" />
                                            <div className="title px-2">Oui</div>
                                        </label>
                                        ...
                                        <label className="flex radio p-2 cursor-pointer">
                                            <input className="my-auto transform scale-125" type="radio"
                                                ...
                                                value="Non"
                                                name="maladie" />
                                            <div className="title px-2">Non</div>
                                        </label>
                                ...
                                {secondHid &&
                                    <div className="main flex border rounded-full overflow-hidden m-4 select-none">
                                        <div className="title py-3 my-auto px-5 bg-red-500 text-white text-sm font-semibold mr-3">Avez vous des effets secondaire apres votre 1er dose?</div>
                                        <label className="flex radio p-2 cursor-pointer">
                                            <input className="my-auto transform scale-125" type="radio"
                                                onChange={(e) => {
                                ...
                                {tirthHid &&
                                    <div className="main flex border rounded-full overflow-hidden m-4 select-none">
                                        <div className="title py-3 my-auto px-5 bg-red-500 text-white text-sm font-semibold mr-3">Avez vous des effets secondaire apres votre 2eme dose?</div>
                                        <label className="flex radio p-2 cursor-pointer">
                                            <input className="my-auto transform scale-125" type="radio"
                                                onChange={(e) => {
                                ...
                                {hiden &&
                                    ...
                                    <>
                                        <div className="main flex border rounded-full overflow-hidden m-4 select-none">
                                            <div className="title py-3 my-auto px-5 bg-red-500 text-white text-sm font-semibold mr-3">Traitement</div>
                                            {maladies.map((maladie, index) => (
                                                <>

                                                    <label key={index} className="flex radio p-2 cursor-pointer">
                                                        <input className="my-auto transform scale-125" type="radio"
                                        ...
                                        <div className="main flex border rounded-full overflow-hidden m-4 select-none">
                                            <div className="title py-3 my-auto px-5 bg-red-500 text-white text-sm font-semibold mr-3">Medicament</div>
